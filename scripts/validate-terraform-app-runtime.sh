...
required_stage_patterns = {
    ...
    "product API metadata store secret local": r"product_api_metadata_store_secret_configured",
    "product API metadata store secret env name": r"ConnectionStrings__ProductMetadataStore",
    "product API metadata store secret precondition": r"container_app_secret_names\.product_api\s+must\s+include\s+ConnectionStrings__ProductMetadataStore",
